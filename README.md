...
# 5个PHP探针分享
[雅黑PHP探针](https://distribute.byzkk.com/web/zkkme/img/0012/assets/yaheitz.zip)
[X探针](https://api.inn-studio.com/download?id=xprober)
[（刘海探针）](https://distribute.byzkk.com/web/zkkme/img/0012/assets/x.zip)
[PHPProbe探针](https://distribute.byzkk.com/web/zkkme/img/0012/assets/phpprobe.zip)
[原版Github仓库](https://github.com/fbcha/phpprobe)
[UPUPW PHP探针安全版](https://distribute.byzkk.com/web/zkkme/img/0012/assets/upupw.zip)

# 安卓下载站、影视站、图床
这里有6个可以完美替代Google Play 的网站或App。
<br>
替代谷歌Play 第三方安卓APK下载商店推荐
[APKPure](https://apkpure.com/cn/)
APKPure 是知名度很高的免费安卓应用商店，基本上大部分Google Play上架的软件都可以在这里找到。
[Aurora Store](https://aurora-store.cn.uptodown.com/android)
Aurora Store也是一个完全免费且开源的应用商店，而且兼容原生安卓，不需要GMS也能完美安装及使用。
[Aptoide](https://en.aptoide.com/)
<br>
[APK Combo](https://apkcombo.com/zh/)
<br>
[apkdl.in](https://apkdl.in/)
bot：@apkdl_bot
<br>
